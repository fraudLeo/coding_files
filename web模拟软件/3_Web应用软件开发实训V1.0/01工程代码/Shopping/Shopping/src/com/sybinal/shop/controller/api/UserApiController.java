...
public class UserApiController extends AbstractApiController {
	...
	public ApiResponseObject saveOption(@PathVariable("currentPage") int currentPage,@RequestParam("userId") int userId) {
	...
	public ApiResponseObject delWishlist(@RequestParam("userId") int userId,@RequestParam("wishlisId") int wishlisId) {
		Map<String, Object> reqMap = new HashMap<>();
		reqMap.put("userId", userId);
		reqMap.put("wishlisId", wishlisId);
	...
	public ApiResponseObject saveWishlist(Wishlist wishlist) {
	...
	public ApiResponseObject saveUser(User user) throws IllegalAccessException, InvocationTargetException {
	...
	public ApiResponseObject getUserInfo(User user)throws IllegalAccessException, InvocationTargetException {
		User newUser = userService.getUser(user);
		if (newUser == null) {
	...
	public ApiResponseObject getUserBasic(@RequestParam("userId") int userId) {
		Map<String,Object> reqMap = new HashMap<>();
		reqMap.put("userId",userId);
	...
	public ApiResponseObject updateUser(User user)throws IllegalAccessException, InvocationTargetException {
	...
	public ApiResponseObject updatePassword(@RequestParam("userId") int userId,@RequestParam("oldpassword") String oldpassword,@RequestParam("rpassword") String rpassword)
	...
	public ApiResponseObject recoveryPassword(User user) throws IllegalAccessException, InvocationTargetException {
	...
	public ApiResponseObject sendMessage(User user)
			throws IllegalAccessException, InvocationTargetException {
	...
	public ApiResponseObject saveContect(Contect contect){
	...
	public ApiResponseObject getContect(Contect contect) {
		if(StringUtils.isEmpty(contect.getUserId())){
			return this.reponseJSON(ApiResponseEnum.ERROR_PARAM.getCode(), ApiResponseEnum.ERROR_PARAM.getName(), null);
		}
	...
	public ApiResponseObject removeContect(Contect contect) {
	...
	public ApiResponseObject updateContect(Contect contect) {
		if(StringUtils.isEmpty(contect.getUserId()) || StringUtils.isEmpty(contect.getId())){
			return this.reponseJSON(ApiResponseEnum.ERROR_PARAM.getCode(), ApiResponseEnum.ERROR_PARAM.getName(), null);
		}
	...
	public ApiResponseObject defaultContect(Contect contect) {
