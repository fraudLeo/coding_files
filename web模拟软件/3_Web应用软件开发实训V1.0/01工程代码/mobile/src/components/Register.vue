<template>
  <div class="reg">
    ...
    <div class="container">
      ...
      <van-button @click="reg" block class="cell" large size="large" square type="primary">立即注册</van-button>
    </div>
  </div>
  ...
  export default {
    ...
    methods: {
      reg () {
        ...
        else this.$form (this.$api.REGISTER, {userName: this.phone, pwd: this.userPassword, amount: 0}).then (res => {
            if (res.errorCode == '0') {
